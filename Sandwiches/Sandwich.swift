...
struct Sandwich: Identifiable, Equatable {
    var id = UUID()
    var name: String
...
let testData = [
    ...
    Sandwich(name: "Croque madame", ingredientCount: 4, isSpicy: true),
    Sandwich(name: "Hot dog", ingredientCount: 2, isSpicy: false),
    Sandwich(name: "Fluffernutter", ingredientCount: 2, isSpicy: true),
